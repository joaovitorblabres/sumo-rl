...
if __name__ == '__main__':
    ...
    debug = args.debug
    out_csv = 'outputs/{}{}{}BIG/gamma{}_eps{}_decay{}/{}/{}/'.format(['PO_' if args.algType else 'HV_'][0], ['FIXED_' if args.fixed else ''][0], ['DEBUG_' if args.debug else ''][0], args.gamma, args.epsilon, args.decay, experiment_time[0], experiment_time[1])
