...
class PQLAgent:
    ...
    def __init__(self, starting_state, state_space, action_space, ref_point, gamma=0.95, exploration_strategy=EpsilonGreedy(), number_obejctives=2):
        ...
        # self.non_dominated = [[[np.array([100,0])] for _ in range(self.action_space.n)] for _ in range(self.state_space)]
    ...
    def update_non_dominated(self, s, a, s_n):
        ...
        myset = np.unique(solutions[nonD].round(decimals=4), axis=0)
